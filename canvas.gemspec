...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/canvas/widgets/alert.rb",
    "lib/canvas/widgets/application_osx.rb",
    "lib/canvas/widgets/window_dark.rb",
    "lib/canvas/widgets/window_osx.rb",
    "spec/canvas/canvas_spec.rb",
    "spec/spec_helper.rb",
    "tasks/bacon.rake",
    "tasks/setup.rake"
  ]
  s.homepage = "http://github.com/patrickhno/canvas"
  s.licenses = ["MIT"]
